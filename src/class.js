...
//Cabeça da maquina[retornar o status atual e o altera]
class Head {
    ...
    get status(){
        return `Estado: ${this.state} | Posição: ${this.location}`
    }
...
class Machine {
    ...
    //Instruções para a maquina
    stepLookup() {
        if (this.ruleset[this.head.state]
    ...
    step() {
        ...
        this.tape.write(new_symbol, this.head.location)//aqui vai escrever o symbolo 
        this.head.state = new_state // altera o status
        this.shiftHead(move)// move a cabeça
    }
